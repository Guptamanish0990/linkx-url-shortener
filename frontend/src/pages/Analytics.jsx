...
export default function Analytics() {
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      ...
      try {
        ...
        console.log('Analytics data fetched:', analyticsData); // Log the state after setting
        setLoading(false);
      }
    };
  ...
  if (!analyticsData || Object.keys(analyticsData).length === 0) { // Check for empty object too
